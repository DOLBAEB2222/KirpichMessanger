...
func (s *ChatService) GetUserChatsWithLastMessage(ctx context.Context, userID uuid.UUID) ([]models.ChatResponse, error) {
	...
	s.redis.Set(ctx, cacheKey, chatData, 30*time.Second)
