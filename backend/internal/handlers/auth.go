...
func (h *AuthHandler) Register(c fiber.Ctx) error {
    ...
    h.auditService.Log(&user.ID, string(models.ActionRegister), c.IP(), c.Get("User-Agent"), correlationID, nil)
...
func (h *AuthHandler) Login(c fiber.Ctx) error {
    ...
    correlationID, _ := c.Locals("correlationID").(string)
    h.auditService.Log(&user.ID, string(models.ActionLogin), c.IP(), c.Get("User-Agent"), correlationID, nil)
